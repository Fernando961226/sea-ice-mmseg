...
crop_size = (512, 512)
scale = (512, 512)
downsample_factor_train = [2]   # List all downsampling factors from 2X to 10X to include during training
...
model = dict(
    ...
    test_cfg=dict(mode='slide', crop_size=crop_size, stride=(crop_size[0] *50//100, crop_size[1]*50//100)))
